...
/>
                                ...
                                <span className="alerts__text">
                                  <strong>
                                    ...
                                    {(() => {
                                      ...
                                      const h2 = getHeadData['EX1.H2_PV'] ?? getHeadData?.EX1?.H2_PV ?? '-';
                                      const h3 = getHeadData['EX1.H3_PV'] ?? getHeadData?.EX1?.H3_PV ?? '-';
                                      const h4 = getHeadData['EX1.H4_PV'] ?? getHeadData?.EX1?.H4_PV ?? '-';
                                      const z1 = getScrewData['EX1.Z1_PV'] ?? getScrewData?.EX1?.Z1_PV ?? '-';
                                      const z2 = getScrewData['EX1.Z2_PV'] ?? getScrewData?.EX1?.Z2_PV ?? '-';
                                      const z4 = getScrewData['EX1.Z4_PV'] ?? getScrewData?.EX1?.Z4_PV ?? '-';
                                      
                                      return (
                                        <span style={{ marginLeft: 8 }} className="alerts__text">
                                        &nbsp;
                                        압출헤드온도 <span style={{color:"#7fb6cf"}}>H2{h2}</span>, <span style={{color:"#f6d365"}}>H3{h3}</span>, <span style={{color:"#ff6b6b"}}>H4{h4}</span> 
                                        &nbsp;압출스크류 <span style={{color:"#6bc7ad"}}>Z1{z1}</span>, <span style={{color:"#bdb2ff"}}>Z2{z2}</span> <span style={{color:"#a0e8af"}}>Z4{z4}</span> 불량이 발생했습니다
                                        </span>     
                                      );
                                    })()}
                                  </strong>
            ...
            <section className="grid-2">
                ...
                <div className="panel">
                    <div className="panel__title">(압출헤드온도) : {HEAD_KEYS.join(", ")}</div>
                ...
                <div className="panel">
                    <div className="panel__title">(압출스크류) : {SCREW_KEYS.join(", ")}</div>
                    <div className="chart-scroll">
                        <div className="chart-scroll__inner">
                            <ResponsiveContainer width="100%" height={350}>
